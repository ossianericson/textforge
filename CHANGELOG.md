...
> Session: README onboarding clarity - IN PROGRESS
...
- Branch guard
- Create TODO.md
- Read readme source files
- Rewrite Getting Started in shared.md
- Add portable pointer to public.md
- npm run readme:internal
- npm run readme:public
- Spot-check README.md
- npm run build
- npm test
- npm run validate:spec
- npm run export:public
- Spot-check public export README
