  ...
  return (
    ...
    >
        ...
        <div className="relative">
          ...
          {openMenu === 'file' ? (
            <MenuSurface align="left">
              ...
              <MenuItem label="Open spec" description="Open a local spec.md file" onClick={() => { void openFile(); closeMenu(); }} />
              ...
              <MenuItem label={isDirty ? 'Save changes' : 'Save'} description="Write the current spec to disk" onClick={() => { void saveFile(); closeMenu(); }} disabled={!isDirty} />
              <MenuItem label="Save as" description="Save under a different file name" onClick={() => { void saveFileAs(); closeMenu(); }} />
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <ActionButton onClick={() => void compile()} title="Compile and Preview (Ctrl+P)" disabled={!spec || isCompiling} dataTourId="preview-button" emphasis>
