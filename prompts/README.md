...
The context snapshots (`textforge-context-internal.md` and `textforge-context-external.md`) are never committed — they live outside
the repository and are regenerated at the end of every session.
