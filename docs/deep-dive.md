...
- The public export includes the desktop editor source under `editor/` plus the release-layout note at `artifacts/editor/README.md`; the exported repository stays source-only, and prebuilt Windows portable downloads are published through GitHub Releases instead of committed under `artifacts/editor/`.
...
- Public release flow: maintainers of the internal export pipeline
