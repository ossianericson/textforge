...
| Trust tier classification | All shipped Tauri commands are classified Built-in, Supervised, Controlled, or Restricted in `docs/security/trust-tiers.md`. Credential acquisition is Controlled and credential clearing is Restricted. | ✅ Implemented |
